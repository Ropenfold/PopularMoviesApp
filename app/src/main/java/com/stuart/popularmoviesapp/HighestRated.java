...
public class HighestRated extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<Film>>,
        SharedPreferences.OnSharedPreferenceChangeListener {

    public static String NOW_PLAYING_URL = "https://api.themoviedb.org/3/movie/now_playing?api_key=ad0550bad192b8c963c53f60ccc01331&language=en-US&page=1";
    public static String HIGHEST_RATING_URL = "https://api.themoviedb.org/3/movie/top_rated?api_key=ad0550bad192b8c963c53f60ccc01331&language=en-US&page=1";
    ...
    public Loader<List<Film>> onCreateLoader(int i, Bundle bundle) {
        return new FilmListLoader(this, HIGHEST_RATING_URL);
    }
